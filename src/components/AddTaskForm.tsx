  ...
  if (!open) {
    return (
      <button
        ...
        className="flex w-full items-center gap-2 rounded-xl border border-dashed border-blue-100 px-4 py-3 text-sm text-slate-400 transition-colors hover:border-blue-100 hover:text-slate-600"
      >
        <Plus size={14} />
        Add task
      </button>
